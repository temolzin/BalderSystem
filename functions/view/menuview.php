...
class Menu {
  ...
  public $moduloprivilegiousuario, $privilegiousuario;
  ...
  public function __construct()
  {
    ...
    $this->moduloprivilegiousuario = $_SESSION['user']['nombre_modulo_privilegio'];
    $this->privilegiousuario = $_SESSION['user']['nombre_privilegio'];
  }
